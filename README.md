...
> `vercel.json` 已配好短路由:`/redis`、`/mysql`、`/spring`、`/boot`、`/juc`、`/jvm`、`/netty`、`/net`、`/kafka`、`/es`、`/k8s`、`/patterns`、`/cloud`、`/llm`、`/arch`、`/agent`;并默认开启 clean URL(`/redis-illustrated.html` 也可写作 `/redis-illustrated`)。
